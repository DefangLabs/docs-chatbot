...
def parse_markdown():
    ...
    recursive_parse_directory('.')  # Parse markdown files in the current directory
    print("Markdown parsing completed successfully.")

def reset_knowledge_base():
    """ Resets or initializes the knowledge base JSON file. """
    with open('../../app/knowledge_base.json', 'w') as output_file:
...
def parse_markdown_file_to_json(file_path):
    ...
    try:
        ...
        with open('../../app/knowledge_base.json', 'r') as existing_file:
    ...
    with open('../../app/knowledge_base.json', 'w', encoding='utf-8') as output_file:
