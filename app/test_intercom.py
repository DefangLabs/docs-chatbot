...
class TestIntercom(unittest.TestCase):
    ...
    def test_parse_html_to_text(self):
        self.assertEqual(
            self.app.parse_html_to_text("<p>Hello, world!</p>"), "Hello, world!"
        )
    ...
    def test_extract_latest_user_messages(self):
        ...
        conversation_parts = [
            {
                "body": "<p>Admin message</p>",
                "author": {"type": "admin"},
                "created_at": 1,
            },
            {
                "body": "<p>User message 1</p>",
                "author": {"type": "user"},
                "created_at": 2,
            },
            {
                "body": "<p>User message 2</p>",
                "author": {"type": "user"},
                "created_at": 3,
            },
        ]
    ...
    def test_extract_latest_user_messages_after_admin(self):
        conversation_parts = [
            ...
            {
                "body": "<p>Admin message 2</p>",
                "author": {"type": "admin"},
                "created_at": 4,
            },
            {
                "body": "<p>User message 3</p>",
                "author": {"type": "user"},
                "created_at": 5,
            },
        ]
